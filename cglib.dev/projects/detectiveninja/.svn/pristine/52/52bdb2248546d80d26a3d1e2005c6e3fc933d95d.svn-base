...
namespace proj {
    ...
    void MainCamera::init() {
		...
		_target = dynamic_cast<WorldObject*>(cg::Registry::instance()->get("Ninja"));
...
# define GLUT_WHEEL_DOWN 4
    ...
    void MainCamera::draw() {
		...
		gluLookAt(	_position[0],_position[1],_position[2],
					_target->getPosition()[0], _target->getPosition()[1], _target->getPosition()[2] + 6.0,
					_up[0], _up[1], _up[2]);
    }
